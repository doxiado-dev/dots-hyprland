...
warn_files_tests+=(/usr/local/share/icons/macOS-Monterey)
...
printf "\n"
printf "\e[1;34mAnd Optionally, do Recorder & Screenshotter's initial setup: \e[0m\n"
printf "\e[30m\e[46m vnrez \e[0m\n"
printf "\n"
