  ...
  [
    {
      ...
      binds: [
        ...
        { keys: ["󰖳", "+", "H"], action: "Toggle this cheatsheet" },
    ...
    },
    {
      ...
      binds: [
        ...
        { keys: ["Shift", "+", "Print"], action: "Record region with sound" },
        {
          keys: ["Ctrl", "Shift", "+", "Print"],
          action: "Record region with FullScreen",
        },
        {
          keys: ["Ctrl", "Shift", "Alt", "+", "Print"],
          action: "Record screen with GIF Output",
        },
      ],
      id: 5,
    },
