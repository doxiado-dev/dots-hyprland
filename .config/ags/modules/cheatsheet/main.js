      ...
      setup: (self) =>
        self.on("key-press-event", (widget, event) => {
          ...
          if (checkKeybind(event, userOptions.keybinds.cheatsheet.nextTab))
            ...
            checkKeybind(event, userOptions.keybinds.cheatsheet.cycleTab)
          )
          ...
          if (
            ...
            if (
              checkKeybind(
                event,
                userOptions.keybinds.cheatsheet.keybinds.nextTab,
              )
            ) {
              ...
              checkKeybind(
                event,
                userOptions.keybinds.cheatsheet.keybinds.prevTab,
              )
            ) {
              sheetContents.forEach((sheet) => {
                const toSwitchTab =
