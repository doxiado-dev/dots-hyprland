            ...
            ImageAction({
              ...
              action: (self) => {
                execAsync([
                  "bash",
                  "-c",
                  `mkdir -p $(xdg-user-dir PICTURES)/homework${thisBlock.attribute.isNsfw ? "/🌶️" : ""} && cp ${thisBlock.attribute.imagePath} $(xdg-user-dir PICTURES)/homework${thisBlock.attribute.isNsfw ? "/🌶️/" : ""}`,
                ])
